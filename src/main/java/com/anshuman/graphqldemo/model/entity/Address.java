...
public class Address {
    ...
    public Address(final Integer id, @NotNull final String addressLine, final String addressLine2,
                   @NotNull final String district, final String postalCode, @NotNull final String phone) {
        this.id = id;
